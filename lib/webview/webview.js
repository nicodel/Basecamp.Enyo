enyo.kind({
    ...
    components: [
        ...
        {kind: "onyx.Button", classes: "floating-menu",name: "backb", content: "Back", disabled: true, onclick: "goPrevious"},
        {kind: "onyx.Button", classes: "floating-menu-right", content: "Forward", name: "forb", disabled: true, onclick: "goNext"},
        {kind: "Scroller", classes: "enyo-fit", components: [
            {name: "content", onclick: "catchtap", content:"", allowHtml: true}
        ]}
    ],
    create: function () {
    ...
    loadit: function () {
        ...
        if (this.pages[this.currentPage]){
            ...
            request.response(this, function(inSender, inValue){
                var i=0;
                this.method = "GET";
                this.postBody = "";
    ...
    catchtap: function(inSender, inEvent) { 
        ...
        } else if(inEvent.target.href) { //  process touch event on link
